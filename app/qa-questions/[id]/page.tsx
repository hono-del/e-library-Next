...
import { getWorkflowQA, SessionContext } from '@/app/lib/workflow-content'
...
export default function QADetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const question = getWorkflowQA(id, sessionContext) ?? Object.values(mockRecommendations)
...
${sessionContext.vehicleModel} ${sessionContext.modelYear}年式は、リアO2センサーのコネクタ部分に水が入りやすいという報告もあります。コネクタ内部も確認してみてください。`,
    },
    {
      id: 'ans-3',
      isBest: false,
      ...
      helpful: 5,
      content: '部品情報を追加します。',
      detail: `${sessionContext.vehicleModel} ${sessionContext.modelYear}年式のリアO2センサーの部品番号は以下の通りです:
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="card p-6 mb-6">
        ...
        <div className="space-y-3 text-gray-700">
          <p>
            {sessionContext.vehicleModel} {sessionContext.modelYear}年式で、P0420（触媒効率低下）が発生しています。
          </p>
          <p>
          ...
          <div className="bg-gray-50 rounded p-3 mt-4">
            ...
            <ul className="text-sm space-y-1">
              <li>• 車種: {sessionContext.vehicleModel}</li>
              <li>• 年式: {sessionContext.modelYear}年</li>
